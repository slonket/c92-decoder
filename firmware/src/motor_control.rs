...
pub struct MotorControl<const MAX_PWM: i32> {
    ...
    motor_fw: Option<PB3<Output<PushPull>>>,
    motor_rv: Option<PB4<Output<PushPull>>>,
...
impl<const PWM_MAX: i32> MotorControl<PWM_MAX> {
    ...
    pub fn init(&mut self, motor_fw: PB3<Output<PushPull>>, motor_rv: PB4<Output<PushPull>>, tim2: &tim2::RegisterBlock) {
