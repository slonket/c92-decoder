...
pub const T_BEMF: u32 = 1000;   // BEMF cutout duration (us)
pub const T_ADC: u32 = 750;     // ADC conversion start time (us)
...
pub const BEMF_MIN: u16 = 40;   // minimum speed value
pub const BEMF_MAX: u16 = 3760; // maximum speed value (12V BEMF from divider = 3.03V)

// GAIN SCHEDULE
pub const GAIN_BLEND_LOW: i32 = 40;   // below this = full crawl gains
pub const GAIN_BLEND_HIGH: i32 = 200; // above this = full normal gains

// PI CONTROLLER GAINS
pub const KP_NORM: i32 = 500;   // normal proportion co-efficient
pub const KI_NORM: i32 = 60;    // normal integrator co-efficient
pub const KP_CRAWL: i32 = 2750; // crawl proportion co-efficient
pub const KI_CRAWL: i32 = 800;  // crawl integrator co-efficient